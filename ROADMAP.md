...
- [ ] **M8.1 — amiga-runtime adapter:** define and document the FellowNG invocation/profile/result mapping required by external runtime orchestration while keeping `fellowng.runtime-result.v1` stable.
